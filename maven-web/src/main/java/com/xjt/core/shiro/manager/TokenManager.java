package com.xjt.core.shiro.manager;
...
import com.xjt.core.utils.SpringContextUtil;
import com.xjt.core.shiro.session.CustomSessionManager;
import com.xjt.core.shiro.realm.MyRealm;
...
public class TokenManager {
	 ...
	 * @return
	 */
	public static Home getToken(){
		Home token = (Home)SecurityUtils.getSubject().getPrincipal();
		return token ;
	}
	 ...
	 * @return
	 */
	public static Home login(Home user,Boolean rememberMe){
