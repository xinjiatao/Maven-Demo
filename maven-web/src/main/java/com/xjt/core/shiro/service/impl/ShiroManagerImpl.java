package com.xjt.core.shiro.service.impl;
...
import com.xjt.core.utils.LoggerUtils;
import com.xjt.core.config.INI4j;
import com.xjt.core.shiro.service.ShiroManager;
/**
 * 
 * 开发公司：SOJSON在线工具 <p>
...
public class ShiroManagerImpl implements ShiroManager {
	...
	public String loadFilterChainDefinitions() {
		StringBuffer sb = new StringBuffer();
			sb.append(getFixedAuthRule2());//固定权限，采用读取配置文件
		return sb.toString();
	}
	 ...
	 * 从配额文件获取固定权限验证规则串
	 */
	private String getFixedAuthRule2(){
		StringBuffer sb = new StringBuffer();
		try {
			String fileName = "shiro_base_auth.ini";
			ClassPathResource cp = new ClassPathResource(fileName);
			INI4j ini = new INI4j();
			Map<String,String> mapStr = ini.getProFile(cp.getFile(), "");
